...
export const MobileNavList: FC<MobileNavListProps> = ({
  ...
  return (
    <>
      <div
        className={`pt-20 z-[9998] transition-all duration-500 h-screen absolute top-0 bottom-0 w-60 bg-slate-900 filter brightness-[1.2] ${
      ...
      >
        <Link href="/" passHref>
          <img
            ...
            className="h-14 mx-4 mb-6 w-auto cursor-pointer"
          />
        </Link>
        {NAV_LINKS.map((each) => (
          <MobileNavElement
