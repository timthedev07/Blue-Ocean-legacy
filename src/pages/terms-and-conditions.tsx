  ...
  return (
    <>
      ...
      <p>
        ...
        of Blue Ocean International Corporation&apos;s Website, located at{" "}
        {metadata.domain.replace("https://", "")}.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Blue Ocean International Corporation
      ...
      <p>
        ...
        Corporation, you agreed to use cookies in agreement with the Blue Ocean
        International Corporation&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Blue Ocean International Corporation and/or its
        licensors own the intellectual property rights for all material on Blue
        Ocean International Corporation. All intellectual property rights are
        reserved. You may access this from Blue Ocean International Corporation
      ...
      <ul>
        ...
        <li>Redistribute content from Blue Ocean International Corporation</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Blue
        Ocean International Corporation does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of Blue Ocean International Corporation,its
        ...
        applicable laws, Blue Ocean International Corporation shall not be
      ...
      <p>
        ...
        e-mail to Blue Ocean International Corporation. Please include your
