...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      ...
      <h1>Privacy Policy for Blue Ocean International Corporation</h1>

      <p>
        At Blue Ocean International Corporation, accessible from
        {metadata.domain.replace("https://", "")}, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by Blue Ocean
        International Corporation and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Blue Ocean International Corporation. This
      ...
      <p>
        Blue Ocean International Corporation follows a standard procedure of
      ...
      <p>
        Like any other website, Blue Ocean International Corporation uses
      ...
      <p>
        ...
        advertising partners of Blue Ocean International Corporation.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Blue Ocean International
        Corporation, which are sent directly to users&apos; browser. They
      ...
      <p>
        Note that Blue Ocean International Corporation has no access to or
      ...
      <p>
        Blue Ocean International Corporation&apos;s Privacy Policy does not
      ...
      <p>
        Blue Ocean International Corporation does not knowingly collect any
